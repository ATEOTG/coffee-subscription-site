  ...
  return (
    <section className="center">
      <IntroCard
        ...
        header="About us"
        paragraph="Coffeeroasters began its journey of exotic discovery in 1999, highlighting stories of coffe from around the world. We have since been dedicated t obring the perfect cup - from bean to brew in every shipment."
      />
      <AboutCommitment />
      <AboutQuality />
      <AboutLocation />
